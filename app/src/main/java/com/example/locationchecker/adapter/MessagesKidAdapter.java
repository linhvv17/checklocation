...
public class MessagesKidAdapter extends RecyclerView.Adapter<MessagesKidAdapter.ViewHolder> {
...
//    FirebaseUser firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
    ...
    public MessagesKidAdapter(List<Messages> arrMessages, Context context) {
    ...
    public int getItemViewType(int position) {
        if (arrMessages.get(position).getSender() == code) {
